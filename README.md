...
|---|----|---|
|load_train_data_path|	./solution/sample_data/train/|	학습 데이터가 위치한 폴더 경로를 입력합니다(csv 파일 명 입력 X).|
|load_inference_data_path|	./solution/sample_data/test/|	추론 데이터가 위치한 폴더 경로를 입력합니다(csv 파일 명 입력 X).|
